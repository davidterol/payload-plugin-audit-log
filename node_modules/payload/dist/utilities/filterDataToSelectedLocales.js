 ...
 */ function filterLocaleMap(localeMap, selectedLocales, transform) {
    const filtered = {};
    const localesToInclude = selectedLocales && selectedLocales.length > 0 ? selectedLocales : Object.keys(localeMap);
                ...
                case 'array':
                    {
                        ...
                        if (fieldIsLocalized) {
                            if (arrayValue && typeof arrayValue === 'object' && !Array.isArray(arrayValue)) {
                                result[field.name] = filterLocaleMap(arrayValue, selectedLocales, (localeRows)=>Array.isArray(localeRows) ? localeRows.map((item)=>filterDataToSelectedLocales({
                            ...
                            result[field.name] = arrayValue.map((item)=>filterDataToSelectedLocales({
                                    configBlockReferences,
                                    docWithLocales: item,
                                    fields: field.fields,
                                    parentIsLocalized: fieldIsLocalized,
                ...
                case 'blocks':
                    {
                        ...
                        if (fieldIsLocalized) {
                            if (blocksValue && typeof blocksValue === 'object' && !Array.isArray(blocksValue)) {
                                result[field.name] = filterLocaleMap(blocksValue, selectedLocales, (localeRows)=>processBlockRows(localeRows));
                            }
                        ...
                        if (field.name in docWithLocales) {
                            ...
                            if (fieldIsLocalized) {
                                if (value && typeof value === 'object' && !Array.isArray(value)) {
                                    result[field.name] = filterLocaleMap(value, selectedLocales, (localeValue)=>localeValue);
                                }
                            } else {
