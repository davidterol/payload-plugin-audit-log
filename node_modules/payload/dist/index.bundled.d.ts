...
declare const enTranslations: {
    ...
    error: {
        ...
        failedToResetLayout: string;
        failedToSaveLayout: string;
 ...
 */
type GlobalsWithoutDrafts = {
    [TSlug in GlobalSlug]: DataFromGlobalSlug<TSlug> extends {
        _status?: any;
    } ? never : TSlug;
}[GlobalSlug];
/**
 ...
 */
type DraftFlagFromGlobalSlug<TSlug extends GlobalSlug> = GeneratedTypes extends {
...
type WidgetInstance<TSlug extends WidgetSlug = WidgetSlug> = TSlug extends WidgetSlug ? {
...
type PublishButtonServerProps = PublishButtonServerPropsOnly;
...
type UnpublishButtonClientProps = {};
type UnpublishButtonServerPropsOnly = {} & ServerProps;
type UnpublishButtonServerProps = UnpublishButtonServerPropsOnly;
...
declare const refreshOperation: (incomingArgs: Arguments$p) => Promise<Result$3>;
...
type Arguments$o<TSlug extends AuthCollectionSlug> = {
    collection: Collection;
    data: {
        [key: string]: unknown;
...
declare const forgotPasswordOperation: <TSlug extends AuthCollectionSlug>(incomingArgs: Arguments$o<TSlug>) => Promise<null | string>;
 ...
 */
declare const checkLoginPermission: <TSlug extends AuthCollectionSlug>({ loggingInWithUsername, req, user, }: CheckLoginPermissionArgs<TSlug>) => void;
declare const loginOperation: <TSlug extends AuthCollectionSlug>(incomingArgs: Arguments$n<TSlug>) => Promise<LoginResult<TSlug>>;
...
declare const resetPasswordOperation: <TSlug extends AuthCollectionSlug>(args: Arguments$m) => Promise<Result$1>;

type Arguments$l<TSlug extends AuthCollectionSlug> = {
    collection: Collection;
    data: AuthOperationsFromCollectionSlug<TSlug>['unlock'];
    overrideAccess?: boolean;
    req: PayloadRequest;
};
declare const unlockOperation: <TSlug extends AuthCollectionSlug>(args: Arguments$l<TSlug>) => Promise<boolean>;
...
type Arguments$g<TSlug extends CollectionSlug, TSelect extends SelectType> = {
    collection: Collection;
    depth?: number;
    disableTransaction?: boolean;
    id: number | string;
...
declare const deleteByIDOperation: <TSlug extends CollectionSlug, TSelect extends SelectType>(incomingArgs: Arguments$g<TSlug, TSelect>) => Promise<TransformCollectionWithSelect<TSlug, TSelect>>;
...
type Options$h<TSlug extends CollectionSlug, TSelect extends SelectType> = BaseFindOptions<TSlug, TSelect> & DraftFlagFromCollectionSlug<TSlug>;
type FindOptions<TSlug extends CollectionSlug, TSelect extends SelectType> = Options$h<TSlug, TSelect>;
 ...
 */
type DraftFlagFromCollectionSlug<TSlug extends CollectionSlug> = GeneratedTypes extends {
    strictDraftTypes: true;
...
type RequiredDataFromCollection<TData extends JsonObject> = MarkOptional<TData, 'collection' | 'createdAt' | 'deletedAt' | 'id' | 'updatedAt'>;
 ...
 */
type DraftDataFromCollection<TData extends JsonObject> = Partial<Omit<TData, 'collection' | 'createdAt' | 'deletedAt' | 'id' | 'sizes' | 'updatedAt'>> & Partial<Pick<TData, 'collection' | 'createdAt' | 'deletedAt' | 'id' | 'sizes' | 'updatedAt'>>;
...
type RefreshHook<T extends TypeWithID = any> = (args: {
    args: Arguments$p;
    user: T;
}) => Promise<Result$3 | void> | (Result$3 | void);
...
type Options$f<TSlug extends AuthCollectionSlug> = {
    collection: TSlug;
    context?: RequestContext;
    data: AuthOperationsFromCollectionSlug<TSlug>['login'];
    depth?: number;
...
type Options$e<TSlug extends AuthCollectionSlug> = {
    collection: TSlug;
    context?: RequestContext;
    data: {
        password: string;
...
type Options$d<TSlug extends AuthCollectionSlug> = {
    collection: TSlug;
    context?: RequestContext;
    data: AuthOperationsFromCollectionSlug<TSlug>['unlock'];
    overrideAccess: boolean;
...
type Options$c<TSlug extends AuthCollectionSlug> = {
    collection: TSlug;
    context?: RequestContext;
    req?: Partial<PayloadRequest>;
    token: string;
...
type BaseOptions$7<TSlug extends CollectionSlug, TSelect extends SelectType> = {
    /**
     * the Collection slug to operate against.
     */
    collection: TSlug;
...
type Options$b<TSlug extends CollectionSlug, TSelect extends SelectType> = GeneratedTypes extends {
     ...
     */
    draft?: boolean;
} & BaseOptions$7<TSlug, TSelect> : TSlug extends CollectionsWithoutDrafts ? {
    data: RequiredDataFromCollectionSlug<TSlug>;
    /**
     * The `draft` property is not allowed because this collection does not have `versions.drafts` enabled.
     */
    draft?: never;
} & BaseOptions$7<TSlug, TSelect> : ({
    /**
     * The data for the document to create.
     */
    data: RequiredDataFromCollectionSlug<TSlug>;
...
type BaseOptions$6<TSlug extends CollectionSlug, TSelect extends SelectType> = {
    /**
     * the Collection slug to operate against.
     */
    collection: TSlug;
...
type BaseOptions$5<TSlug extends CollectionSlug, TSelect extends SelectType> = {
    /**
     * the Collection slug to operate against.
     */
    collection: TSlug;
...
type BaseOptions$4<TSlug extends CollectionSlug> = {
    /**
     * the Collection slug to operate against.
     */
    collection: TSlug;
...
type BaseOptions$3<TSlug extends CollectionSlug> = {
    /**
     * the Collection slug to operate against.
     */
    collection: TSlug;
...
type Options$6<TSlug extends CollectionSlug> = BaseOptions$3<TSlug> & DraftFlagFromCollectionSlug<TSlug>;

type BaseOptions$2<TSlug extends CollectionSlug> = {
    /**
     * the Collection slug to operate against.
     */
    collection: TSlug;
...
type ByIDOptions<TSlug extends CollectionSlug, TSelect extends SelectFromCollectionSlug<TSlug>> = {
     ...
     */
    where?: never;
} & BaseOptions$1<TSlug, TSelect> & DraftFlagFromCollectionSlug<TSlug>;
...
type CountVersionsOptions<TSlug extends CollectionSlug> = {
    /**
     * the Collection slug to operate against.
     */
    collection: TSlug;
...
type Arguments$7<TSlug extends AuthCollectionSlug> = {
    collection: Collection;
...
type TypedWidget<T extends PayloadTypesShape = PayloadTypes> = T extends {
    widgets: infer TWidgets;
} ? TWidgets extends Record<string, unknown> ? TWidgets : Record<string, unknown> : Record<string, unknown>;
...
type WidgetSlug<T extends PayloadTypesShape = PayloadTypes> = StringKeyOf<TypedWidget<T>>;
type DataFromWidgetSlug<TSlug extends WidgetSlug> = TypedWidget[TSlug] extends {
    data?: infer TData;
} ? TData : TypedWidget[TSlug];
...
declare class BasePayload {
     ...
     */
    countVersions: <T extends CollectionSlug>(options: CountVersionsOptions<T>) => Promise<{
        totalDocs: number;
    }>;
    /**
     ...
     */
    create: <TSlug extends CollectionSlug, TSelect extends SelectFromCollectionSlug<TSlug>>(options: Options$b<TSlug, TSelect>) => Promise<TransformCollectionWithSelect<TSlug, TSelect>>;
    crons: Cron[];
    db: DatabaseAdapter;
    decrypt: typeof decrypt;
    destroy: () => Promise<void>;
    duplicate: <TSlug extends CollectionSlug, TSelect extends SelectFromCollectionSlug<TSlug>>(options: Options$a<TSlug, TSelect>) => Promise<TransformCollectionWithSelect<TSlug, TSelect>>;
    ...
    forgotPassword: <TSlug extends CollectionSlug>(options: Options$g<TSlug>) => Promise<Result$2>;
    getAdminURL: () => string;
    getAPIURL: () => string;
    globals: Globals;
    importMap: ImportMap;
    ...
    kv: KVAdapter;
    logger: Logger;
    login: <TSlug extends CollectionSlug>(options: Options$f<TSlug>) => Promise<LoginResult<TSlug>>;
    resetPassword: <TSlug extends CollectionSlug>(options: Options$e<TSlug>) => Promise<Result$1>;
    /**
    ...
    unlock: <TSlug extends CollectionSlug>(options: Options$d<TSlug>) => Promise<boolean>;
    ...
    verifyEmail: <TSlug extends CollectionSlug>(options: Options$c<TSlug>) => Promise<boolean>;
    versions: {
        [slug: string]: any;
    };
