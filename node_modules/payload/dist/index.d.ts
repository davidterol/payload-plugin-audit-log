...
import { type CountOptions } from './collections/operations/local/count.js';
...
import { type CountVersionsOptions } from './collections/operations/local/countVersions.js';
...
export declare class BasePayload {
    ...
    kv: KVAdapter;
    logger: Logger;
    login: <TSlug extends CollectionSlug>(options: LoginOptions<TSlug>) => Promise<LoginResult<TSlug>>;
...
export { createClientBlocks, createClientField, createClientFields, type ServerOnlyFieldAdminProperties, type ServerOnlyFieldProperties, } from './fields/config/client.js';
...
export type { MongoLocalizeStatusArgs, SqlLocalizeStatusArgs, } from './versions/migrations/localizeStatus/index.js';
