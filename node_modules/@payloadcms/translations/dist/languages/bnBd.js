export const bnBdTranslations = {
    ...
    dashboard: {
        ...
        discardMessage: 'আপনার ড্যাশবোর্ড লেআউটে আপনার অসংরক্ষিত পরিবর্তনগুলি রয়েছে। আপনি কি নিশ্চিত যে আপনি তা বাতিল করতে চান?',
        discardTitle: 'পরিবর্তনগুলি বাতিল করবেন?',
        editDashboard: 'ড্যাশবোর্ড সম্পাদনা করুন',
        editingDashboard: 'ড্যাশবোর্ড সম্পাদনা করুন',
        noItems: 'আপনার ড্যাশবোর্ডে কোনো উইজেট নেই। আপনি তা শীর্ষ বারে অবস্থিত "ড্যাশবোর্ড" মেনু থেকে যোগ করতে পারেন।',
    ...
    general: {
        ...
        documentOutOfDate: 'এই নথিটি সাম্প্রতিকভাবে অন্য ব্যবহারকারীর দ্বারা আপডেট করা হয়েছে। আপনার দর্শন আপতিত।',
        ...
        noResultsDescription: 'আপনার দেওয়া ফিল্টারের সাথে মিলে যায় এমন কোনও বিষয় উপস্থিত নেই বা মিলতে পারে এমন কোনও বিষয় বিদ্যমান নেই।',
    ...
    version: {
        ...
        revertUnsuccessful: 'পূর্বাবস্থায় ফেরার ব্যর্থ হয়েছে। কোনও পূর্বে প্রকাশিত সংস্করণ পাওয়া যায়নি।',
