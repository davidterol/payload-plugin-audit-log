export const frTranslations = {
    ...
    dashboard: {
        ...
        discardMessage: 'Vous avez des modifications non enregistrées dans la disposition de votre tableau de bord. Êtes-vous sûr de vouloir les abandonner ?',
        ...
        noItems: 'Il n\'y a pas de widgets sur votre tableau de bord. Vous pouvez les ajouter depuis le menu "Tableau de bord" situé dans la barre supérieure.',
    ...
    general: {
        ...
        documentOutOfDate: 'Ce document a récemment été mis à jour par un autre utilisateur. Votre vue est obsolète.',
        documents: 'Documents',
        duplicate: 'Dupliquer',
        ...
        noResultsDescription: "Soit il n'en existe aucun, soit aucun ne correspond aux filtres que vous avez spécifiés ci-dessus.",
    ...
    version: {
        ...
        aboutToUnpublishIn: 'Vous êtes sur le point de dépublier ce document en {{locale}}. Êtes-vous sûr ?',
        ...
        revertUnsuccessful: "Annulation infructueuse. Aucune version précédemment publiée n'a été trouvée.",
