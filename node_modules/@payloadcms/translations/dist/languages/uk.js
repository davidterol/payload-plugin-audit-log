export const ukTranslations = {
    ...
    dashboard: {
        ...
        discardMessage: 'У вас є незбережені зміни у макеті панелі керування. Ви впевнені, що хочете їх скасувати?',
        discardTitle: 'Відхилити зміни?',
        editDashboard: 'Редагувати макет',
        editingDashboard: 'Редагування макету',
        noItems: 'На вашій панелі немає віджетів. Ви можете додати їх з меню "Головна", розташованого в верхній панелі.',
