export const idTranslations = {
    ...
    dashboard: {
        ...
        discardMessage: 'Anda memiliki perubahan yang belum disimpan pada tata letak dashboard Anda. Apakah Anda yakin ingin membuangnya?',
        discardTitle: 'Buang perubahan?',
        editDashboard: 'Sunting Dasbor',
        editingDashboard: 'Mengedit Dashboard',
        noItems: 'Tidak ada widget di dasbor Anda. Anda dapat menambahkannya dari menu "Dashboard" yang terletak di bar atas.',
    ...
    general: {
        ...
        documentOutOfDate: 'Dokumen ini baru-baru ini diperbarui oleh pengguna lain. Tampilan Anda sudah usang.',
        documents: 'Dokumen',
        duplicate: 'Duplikat',
        ...
        noResultsDescription: 'Baik tidak ada yang ada atau tidak ada yang cocok dengan filter yang telah Anda tentukan di atas.',
    ...
    version: {
        ...
        aboutToUnpublishIn: 'Anda akan menonaktifkan publikasi dokumen ini dalam {{locale}}. Apakah Anda yakin?',
        ...
        revertUnsuccessful: 'Pengembalian gagal. Tidak ada versi yang sebelumnya dipublikasikan ditemukan.',
