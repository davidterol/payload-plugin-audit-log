export const bnInTranslations = {
    ...
    dashboard: {
        ...
        discardMessage: 'আপনার ড্যাশবোর্ড লেআউটে আপনার অসংরক্ষিত পরিবর্তনগুলি রয়েছে। আপনি কি নিশ্চিত যে আপনি তাদের খারিজ করতে চান?',
        discardTitle: 'পরিবর্তন বাতিল করবেন?',
        editDashboard: 'ড্যাশবোর্ড সম্পাদনা করুন',
        editingDashboard: 'ড্যাশবোর্ড সম্পাদনা করা',
        noItems: 'আপনার ড্যাশবোর্ডে কোন উইজেট নেই। আপনি তাদেরকে শীর্ষ বারে অবস্থিত "ড্যাশবোর্ড" মেনু থেকে যোগ করতে পারেন।',
    ...
    general: {
        ...
        documentOutOfDate: 'এই নথিটি সম্প্রতি অন্য ব্যবহারকারীর দ্বারা আপডেট করা হয়েছে। আপনার দেখানো ভার্সন আপ টু ডেট নয়।',
        ...
        noResultsDescription: 'আপনার উপরে নির্দিষ্ট ফিল্টারগুলির সাথে মেলে যায় এমন কোনো বিষয়টি নেই, অথবা সবচেয়ে সম্ভবত কোনো বিষয়টি নেই।',
    ...
    version: {
        ...
        aboutToUnpublishIn: 'আপনি এই দস্তাবেজটি {{locale}} থেকে প্রকাশনা বাতিল করার ব্যাপারে নিশ্চিত আছেন তো?',
