export const esTranslations = {
    authentication: {
        ...
        youAreReceivingResetPassword: 'Estás recibiendo este correo porque se solicitó restablecer la contraseña de tu cuenta. Por favor haz clic en el siguiente enlace o pégalo en tu navegador para completar el proceso:',
    ...
    dashboard: {
        ...
        discardMessage: 'Tiene cambios no guardados en el diseño de su tablero. ¿Está seguro de que desea descartarlos?',
        discardTitle: '¿Desecha los cambios?',
        editDashboard: 'Editar el Panel de Control',
        editingDashboard: 'Editando el Tablero',
        noItems: 'No hay widgets en su tablero. Puede agregarlos desde el menú "Tablero" ubicado en la barra superior.',
    ...
    folder: {
        ...
        moveItemsToFolderConfirmation: 'Está a punto de mover <1>{{count}} {{label}}</1> a <2>{{toFolder}}</2>. ¿Desea continuar?',
        moveItemsToRootConfirmation: 'Está a punto de mover <1>{{count}} {{label}}</1> a la carpeta raíz. ¿Desea continuar?',
        moveItemToFolderConfirmation: 'Está a punto de mover <1>{{title}}</1> a <2>{{toFolder}}</2>. ¿Desea continuar?',
        moveItemToRootConfirmation: 'Está a punto de mover <1>{{title}}</1> a la carpeta raíz. ¿Desea continuar?',
    ...
    general: {
        ...
        aboutToPermanentlyDelete: 'Está a punto de eliminar permanentemente <1>{{title}}</1> ({{label}}). ¿Desea continuar?',
        aboutToPermanentlyDeleteTrash: 'Está a punto de eliminar permanentemente <0>{{count}}</0> <1>{{label}}</1> de la basura. ¿Desea continuar?',
        aboutToRestore: 'Está a punto de restaurar <1>{{title}}</1> ({{label}}). ¿Desea continuar?',
        aboutToRestoreAsDraft: 'Está a punto de restaurar <1>{{title}}</1> ({{label}}) como borrador. ¿Desea continuar?',
        ...
        aboutToTrash: 'Está a punto de mover <1>{{title}}</1> ({{label}}) a la papelera. ¿Desea continuar?',
        ...
        copying: 'Copiando',
        copyRow: 'Copiar fila',
        copyWarning: 'Está a punto de sobrescribir {{to}} con {{from}} para {{label}} {{title}}. ¿Desea continuar?',
        create: 'Crear',
        created: 'Creado',
        ...
        documentOutOfDate: 'Este documento ha sido actualizado recientemente por otro usuario. Su vista está desactualizada.',
        ...
        move: 'Mover',
        moveConfirm: 'Está a punto de mover {{count}} {{label}} a <1>{{destination}}</1>. ¿Desea continuar?',
        ...
        noResults: 'No se encontraron {{label}}. Puede que aún no existan o que no coincidan con los filtros aplicados.',
        noResultsDescription: 'O bien ninguno existe o ninguno coincide con los filtros que ha especificado anteriormente.',
    ...
    version: {
        type: 'Tipo',
        aboutToPublishSelection: 'Se publicarán todos los elementos seleccionados de {{label}}. ¿Desea continuar?',
        aboutToRestore: 'Está a punto de restaurar este documento de {{label}} al estado en el que se encontraba el {{versionDate}}.',
        aboutToRestoreGlobal: 'Está a punto de restaurar el {{label}} global al estado en el que se encontraba el {{versionDate}}.',
        aboutToRevertToPublished: 'Está a punto de revertir los cambios de este documento a su estado publicado. ¿Desea continuar?',
        ...
        aboutToUnpublishSelection: 'Está a punto de despublicar todos los elementos de {{label}} seleccionados. ¿Desea continuar?',
        ...
        revertUnsuccessful: 'Reversión no exitosa. No se encontró ninguna versión previamente publicada.',
