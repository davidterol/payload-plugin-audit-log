export const viTranslations = {
    ...
    dashboard: {
        ...
        discardMessage: 'Bạn có những thay đổi chưa được lưu trên bố cục bảng điều khiển của mình. Bạn có chắc chắn muốn hủy chúng không?',
        discardTitle: 'Hủy thay đổi?',
        editDashboard: 'Chỉnh sửa Bảng điều khiển',
        editingDashboard: 'Chỉnh sửa Bảng điều khiển',
        noItems: 'Trên bảng điều khiển của bạn không có tiện ích nào. Bạn có thể thêm chúng từ menu "Bảng điều khiển" nằm ở thanh trên cùng.',
    ...
    general: {
        ...
        documentOutOfDate: 'Tài liệu này đã được cập nhật gần đây bởi một người dùng khác. Chế độ xem của bạn đã lỗi thời.',
        documents: 'Tài liệu',
        ...
        noResultsDescription: 'Hoặc là không có hoặc không có gì phù hợp với các bộ lọc bạn đã chỉ định ở trên.',
    ...
    version: {
        ...
        aboutToUnpublishIn: 'Bạn đang chuẩn bị hủy xuất bản tài liệu này trong {{locale}}. Bạn có chắc chắn không?',
        ...
        revertUnsuccessful: 'Khôi phục không thành công. Không tìm thấy phiên bản đã xuất bản trước đó.',
