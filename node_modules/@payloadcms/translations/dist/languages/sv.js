export const svTranslations = {
    ...
    dashboard: {
        ...
        discardMessage: 'Du har osparade ändringar i din instrumentpanelslayout. Är du säker på att du vill kasta bort dem?',
        discardTitle: 'Kasta ändringar?',
        editDashboard: 'Redigera instrumentpanel',
        editingDashboard: 'Redigeringspanel',
        noItems: 'Det finns inga widgets på din instrumentpanel. Du kan lägga till dem från "Instrumentpanel" -menyn som finns i den översta fältet.',
    ...
    general: {
        ...
        documentOutOfDate: 'Detta dokument har nyligen uppdaterats av en annan användare. Din vy är föråldrad.',
        documents: 'Dokument',
        duplicate: 'Duplicera',
        ...
        noResultsDescription: 'Antingen finns ingen eller ingen matchar de filter du har specificerat ovan.',
