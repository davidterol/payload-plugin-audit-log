export const nlTranslations = {
    ...
    dashboard: {
        ...
        discardMessage: 'U heeft niet-opgeslagen wijzigingen in de lay-out van uw dashboard. Weet u zeker dat u ze wilt verwijderen?',
        discardTitle: 'Wijzigingen verwerpen?',
        editDashboard: 'Dashboard bewerken',
        editingDashboard: 'Dashboard bewerken',
        noItems: 'Er zijn geen widgets op uw dashboard. U kunt ze toevoegen vanuit het menu "Dashboard" dat zich in de bovenste balk bevindt.',
    ...
    general: {
        ...
        documentOutOfDate: 'Dit document is onlangs bijgewerkt door een andere gebruiker. Uw weergave is verouderd.',
        ...
        noResults: 'Geen {{label}} gevonden. Of er bestaan nog geen {{label}}, of niets komt overeen met de hierboven gespecifieerde filters.',
        noResultsDescription: 'Er bestaan er geen of er komen er geen overeen met de filters die u hierboven heeft opgegeven.',
    ...
    version: {
        ...
        aboutToUnpublishIn: 'U staat op het punt dit document in {{locale}} te onpubliceren. Weet u het zeker?',
