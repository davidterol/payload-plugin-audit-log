export const jaTranslations = {
    ...
    dashboard: {
        ...
        discardMessage: 'あなたのダッシュボードのレイアウトに保存されていない変更があります。それらを破棄してもよろしいですか？',
        discardTitle: '変更を破棄しますか？',
        editDashboard: 'ダッシュボードを編集する',
        editingDashboard: 'ダッシュボードの編集',
        noItems: 'あなたのダッシュボードにはウィジェットがありません。 上部バーにある「ダッシュボード」メニューからそれらを追加することができます。',
    ...
    general: {
        ...
        documentOutOfDate: 'このドキュメントは最近別のユーザーによって更新されました。あなたのビューは古いものです。',
        documents: 'ドキュメント',
        duplicate: '複製',
    ...
    version: {
        ...
        revertUnsuccessful: '元に戻すことができませんでした。以前に公開されたバージョンが見つかりませんでした。',
        saveDraft: 'ドラフトを保存',
