export const roTranslations = {
    ...
    dashboard: {
        ...
        discardMessage: 'Aveți modificări nesalvate la aspectul tabloului de bord. Sigur doriți să le renunțați?',
        discardTitle: 'Anulare modificări?',
        editDashboard: 'Editează Panoul de Control',
        editingDashboard: 'Editare Dashboard',
        noItems: 'Nu există widget-uri pe tabloul dvs. de bord. Le puteți adăuga din meniul "Tablou de bord" situat în bara superioară.',
    ...
    general: {
        ...
        documentOutOfDate: 'Acest document a fost actualizat recent de un alt utilizator. Vizualizarea dvs. este depășită.',
        documents: 'Documente',
        duplicate: 'Duplicați',
