export const arTranslations = {
    ...
    dashboard: {
        ...
        discardMessage: 'لديك تغييرات غير محفوظة في تخطيط لوحة التحكم الخاصة بك. هل أنت متأكد أنك تريد التخلي عنها؟',
        discardTitle: 'هل تريد التخلص من التغييرات؟',
        editDashboard: 'تعديل لوحة التحكم',
        editingDashboard: 'لوحة تحرير',
        noItems: 'لا توجد أدوات على لوحة التحكم الخاصة بك. يمكنك إضافتها من القائمة "لوحة التحكم" الموجودة في الشريط العلوي.',
