export const bgTranslations = {
    ...
    dashboard: {
        ...
        discardMessage: 'Имате незапазени промени в оформлението на таблото си. Сигурни ли сте, че искате да ги отхвърлите?',
        discardTitle: 'Отхвърляне на промените?',
        editDashboard: 'Редактирай таблото',
        editingDashboard: 'Редактиране на таблото',
        noItems: 'Няма джаджи на таблото ви. Можете да ги добавите от менюто "Табло", което е разположено в горната лента.',
    ...
    general: {
        ...
        documentOutOfDate: 'Този документ беше наскоро обновен от друг потребител. Вашият изглед е неактуален.',
        documents: 'Документи',
        ...
        noResultsDescription: 'Или не съществува такава, или никоя не отговаря на филтрите, които сте посочили по-горе.',
    ...
    version: {
        ...
        aboutToUnpublishIn: 'Предстои да премахнете публикацията на този документ в {{locale}}. Сигурни ли сте?',
