export const enTranslations = {
    ...
    dashboard: {
        ...
        discardMessage: 'You have unsaved changes to your dashboard layout. Are you sure you want to discard them?',
        discardTitle: 'Discard changes?',
        editDashboard: 'Edit Dashboard',
        editingDashboard: 'Editing Dashboard',
        noItems: 'There are no widgets on your dashboard. You can add them from the "Dashboard" menu located in the top bar.',
    ...
    general: {
        ...
        documentOutOfDate: 'This document was recently updated by another user. Your view is out of date.',
        documents: 'Documents',
        duplicate: 'Duplicate',
