export const azTranslations = {
    ...
    dashboard: {
        ...
        discardMessage: 'Sizin panel düzenlemənizdə saxlanmamış dəyişikliklər var. Onları ləğvetmək istədiyinizə əminsinizmi?',
        discardTitle: 'Dəyişiklikləri ləğv edin?',
        editDashboard: 'İdarə Panelini Redaktə Et',
        editingDashboard: 'Redaktə Paneli',
        noItems: 'Sizin panelinizdə heç bir vidjet yoxdur. Siz onları yuxarıdaki çubuqda yerləşən "Panel" menyusundan əlavə edə bilərsiniz.',
    ...
    general: {
        ...
        documentOutOfDate: 'Bu sənəd yeni başqa bir istifadəçi tərəfindən yenilənib. Sizin baxışınız köhnədir.',
        documents: 'Sənədlər',
        duplicate: 'Dublikat',
