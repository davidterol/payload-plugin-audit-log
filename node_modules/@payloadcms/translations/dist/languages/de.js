export const deTranslations = {
    authentication: {
        ...
        checkYourEmailForPasswordReset: 'Wenn die E-Mail-Adresse mit einem Benutzerkonto verknüpft ist, erhältst du in Kürze Anweisungen zum Zurücksetzen deines Passworts. Bitte überprüfe auch deinen Spam-Ordner, falls du die E-Mail nicht im Posteingang siehst.',
        ...
        generatingNewAPIKeyWillInvalidate: 'Wenn du einen neuen API-Schlüssel generierst, wird der vorherige <1>ungültig</1>. Bist du sicher, dass du fortfahren möchtest?',
        ...
        youDidNotRequestPassword: 'Solltest du dies nicht angefordert haben, ignoriere diese E-Mail. Dein Passwort bleibt unverändert.'
    },
    dashboard: {
        ...
        discardMessage: 'Du hast ungespeicherte Änderungen an deinem Dashboard-Layout. Bist du sicher, dass du diese verwerfen möchtest?',
        discardTitle: 'Änderungen verwerfen?',
        editDashboard: 'Dashboard bearbeiten',
        editingDashboard: 'Dashboard bearbeiten',
        noItems: 'Auf deinem Dashboard befinden sich keine Widgets. Du kannst diese über das "Dashboard"-Menü in der oberen Leiste hinzufügen.',
    ...
    error: {
        ...
        documentNotFound: 'Das Dokument mit der ID {{id}} konnte nicht gefunden werden. Es könnte gelöscht, niemals existiert haben oder du hast keinen Zugriff darauf.',
        ...
        insufficientClipboardPermissions: 'Zugriff auf die Zwischenablage verweigert. Bitte überprüfe die Berechtigungen.',
        ...
        restoringTitle: 'Es gab einen Fehler beim Wiederherstellen von {{title}}. Bitte überprüfe die Verbindung und versuche es erneut.',
    ...
    folder: {
        ...
        folders: 'Ordner',
        folderTypeDescription: 'Wähle aus, welche Art von Sammlungsdokumenten in diesem Ordner zugelassen sein sollen.',
        ...
        moveItemsToFolderConfirmation: 'Du bist dabei, <1>{{count}} {{label}}</1> nach <2>{{toFolder}}</2> zu verschieben. Bist du dir sicher?',
        moveItemsToRootConfirmation: 'Du bist dabei, <1>{{count}} {{label}}</1> in den Hauptordner zu verschieben. Bist du dir sicher?',
        moveItemToFolderConfirmation: 'Du bist dabei, <1>{{title}}</1> zu <2>{{toFolder}}</2> zu verschieben. Bist du dir sicher?',
        moveItemToRootConfirmation: 'Du bist dabei, <1>{{title}}</1> in den Hauptordner zu verschieben. Bist du dir sicher?',
    ...
    general: {
        ...
        aboutToPermanentlyDelete: 'Du bist dabei, das {{label}} <1>{{title}}</1> dauerhaft zu löschen. Bist du dir sicher?',
        aboutToPermanentlyDeleteTrash: 'Du bist dabei, <0>{{count}}</0> <1>{{label}}</1> endgültig aus dem Papierkorb zu löschen. Bist du dir sicher?',
        aboutToRestore: 'Du bist dabei, das {{label}} <1>{{title}}</1> wiederherzustellen. Bist du dir sicher?',
        aboutToRestoreAsDraft: 'Du bist dabei, das {{label}} <1>{{title}}</1> als Entwurf wiederherzustellen. Bist du dir sicher?',
        aboutToRestoreAsDraftCount: 'Du bist dabei, {{count}} {{label}} als Entwurf wiederherzustellen.',
        aboutToRestoreCount: 'Du bist dabei, {{count}} {{label}} wiederherzustellen.',
        aboutToTrash: 'Du bist dabei, das {{label}} <1>{{title}}</1> in den Papierkorb zu verschieben. Bist du dir sicher?',
        ...
        documentOutOfDate: 'Dieses Dokument wurde kürzlich von einem anderen Benutzer aktualisiert. Deine Ansicht ist veraltet.',
        documents: 'Dokumente',
        ...
        move: 'Verschieben',
        moveConfirm: 'Du bist dabei, {{count}} {{label}} nach <1>{{destination}}</1> zu verschieben. Bist du dir sicher?',
        ...
        noResults: 'Keine {{label}} gefunden. Entweder existieren keine {{label}} oder es gibt keine Übereinstimmung mit den angewendeten Filtern.',
        noResultsDescription: 'Es existieren keine oder keine entsprechen den oben angegebenen Filtern.',
        ...
        unlock: 'Entsperren',
        unsavedChanges: 'Du hast ungespeicherte Änderungen. Speichere oder verwerfe sie, bevor du fortfährst.',
    ...
    validation: {
        ...
        shorterThanMax: 'Dieser Wert muss kürzer als die maximale Länge von {{maxLength}} Zeichen sein.',
    ...
    version: {
        ...
        aboutToUnpublishIn: 'Du bist dabei, dieses Dokument in {{locale}} zu entpublizieren. Bist du dir sicher?',
        aboutToUnpublishSelection: 'Du bist dabei, die Veröffentlichung aller {{label}} in der Auswahl aufzuheben. Bist du sicher?',
