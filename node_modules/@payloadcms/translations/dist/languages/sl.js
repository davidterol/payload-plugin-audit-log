export const slTranslations = {
    ...
    dashboard: {
        ...
        discardMessage: 'Imate neshranjene spremembe postavitve vaše nadzorne plošče. Ste prepričani, da jih želite zavreči?',
        discardTitle: 'Zavržem spremembe?',
        editDashboard: 'Uredi nadzorno ploščo',
        editingDashboard: 'Urejanje nadzorne plošče',
        noItems: 'Na vaši nadzorni plošči ni pripomočkov. Dodate jih lahko iz menija "Nadzorna plošča", ki se nahaja v zgornji vrstici.',
    ...
    general: {
        ...
        documentOutOfDate: 'Ta dokument je bil pred kratkim posodobljen od drugega uporabnika. Vaš pogled je zastarel.',
        documents: 'Dokumenti',
        duplicate: 'Podvoji',
