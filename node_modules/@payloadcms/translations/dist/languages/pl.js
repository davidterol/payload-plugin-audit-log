export const plTranslations = {
    ...
    dashboard: {
        ...
        discardMessage: 'Masz niezapisane zmiany w układzie swojego pulpitu. Czy na pewno chcesz je odrzucić?',
        discardTitle: 'Odrzucić zmiany?',
        editDashboard: 'Edytuj Pulpit',
        editingDashboard: 'Edycja Panelu sterowania',
        noItems: 'Na Twoim pulpicie nie ma żadnych widgetów. Możesz je dodać z menu "Pulpit", które znajduje się na górnej belce.',
    ...
    general: {
        ...
        documentOutOfDate: 'Ten dokument został niedawno zaktualizowany przez innego użytkownika. Twoja wersja jest nieaktualna.',
        documents: 'Dokumenty',
        duplicate: 'Zduplikuj',
