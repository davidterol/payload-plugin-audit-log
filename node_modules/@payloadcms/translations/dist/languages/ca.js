export const caTranslations = {
    ...
    dashboard: {
        ...
        discardMessage: 'Tens canvis no desats en el disseny del teu tauler. Estàs segur que vols descartar-los?',
        discardTitle: 'Descartar canvis?',
        editDashboard: 'Edita el Tauler',
        editingDashboard: 'Editant el Tauler',
        noItems: 'No hi ha cap widget al vostre tauler de control. Podeu afegir-los des del menú "Dashboard" situat a la barra superior.',
    ...
    general: {
        ...
        documentOutOfDate: 'Aquest document ha estat actualitzat recentment per un altre usuari. La seva vista està desactualitzada.',
        documents: 'Documents',
        duplicate: 'Duplicar',
