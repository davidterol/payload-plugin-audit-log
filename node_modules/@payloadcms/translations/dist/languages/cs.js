export const csTranslations = {
    ...
    dashboard: {
        ...
        discardMessage: 'Máte neuložené změny ve vašem uspořádání nástěnky. Jste si jisti, že je chcete zahodit?',
        discardTitle: 'Zahodit změny?',
        editDashboard: 'Upravit řídicí panel',
        editingDashboard: 'Úprava řídícího panelu',
        noItems: 'Na vaší nástěnce nejsou žádné widgety. Můžete je přidat z menu „Nástěnka“, které se nachází v horní liště.',
    ...
    general: {
        ...
        documentOutOfDate: 'Tento dokument byl nedávno aktualizován jiným uživatelem. Váš pohled je zastaralý.',
        documents: 'Dokumenty',
        ...
        noResultsDescription: 'Buď žádné neexistují, nebo žádné neodpovídají filtrům, které jste výše specifikovali.',
    ...
    version: {
        ...
        aboutToUnpublishIn: 'Chystáte se zrušit publikaci tohoto dokumentu v {{locale}}. Jste si jisti?',
