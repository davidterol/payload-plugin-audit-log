export const isTranslations = {
    ...
    dashboard: {
        ...
        discardMessage: 'Þú hefur óvistaðar breytingar á mælaborðsútlitinu þínu. Ertu viss um að þú viljir eyða þeim?',
        discardTitle: 'Hætta við breytingar?',
        editDashboard: 'Breyta mælaborði',
        editingDashboard: 'Breytaborð Breytingar',
        noItems: 'Það eru engar flísar á mælaborðinu þínu. Þú getur bætt þeim við úr "Mælaborði" valmyndinni sem er staðsett í efsta stikanum.',
    ...
    general: {
        ...
        noResultsDescription: 'Það eru hvorki neinar til eða neinar sem passa við síurnar sem þú skilgreindir að ofan.',
