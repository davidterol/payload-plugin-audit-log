export const faTranslations = {
    ...
    dashboard: {
        ...
        discardMessage: 'شما تغییرات ذخیره نشده ای در طرح بندی داشبورد خود دارید. آیا مطمئن هستید که می خواهید آنها را دور بیندازید؟',
        discardTitle: 'تغییرات را دور بیندازید؟',
        editDashboard: 'ویرایش داشبورد',
        editingDashboard: 'داشبورد ویرایش',
        noItems: 'در داشبورد شما هیچ ویجتی وجود ندارد. شما می توانید آنها را از منوی "داشبورد" که در نوار بالا قرار دارد اضافه کنید.',
    ...
    general: {
        ...
        noResultsDescription: 'هیچ کدام وجود ندارند یا هیچ کدام با فیلترهایی که در بالا مشخص کرده اید مطابقت ندارند.',
